...
contract GenesisNFT is ERC721Drop {
     ...
     */
    function setIkigaiToken(address _ikigaiToken) external onlyRole(DEFAULT_ADMIN_ROLE) {
     ...
     */
    function setTokensPerNFT(uint256 _tokensPerNFT) external onlyRole(DEFAULT_ADMIN_ROLE) {
